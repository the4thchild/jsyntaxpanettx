...
// CHANGED: extends StyledEditorKit rather than DefaultEditorKit to allow
// use in JTextPane
 ...
 * @author ayman
 */
public class DefaultSyntaxKit extends StyledEditorKit implements ViewFactory {
	...
	public View create(Element element) {
		setView(wrapped 
				? new SyntaxViewWrapped(element, getConfig()) 
				: new SyntaxView(element, getConfig()));
		return view;
	}
	
	// ADDED: flag for using SyntaxViewWrapped (copy of SyntaxView that
	// extends WrappedPlainView instead of PlainView)
	private static boolean wrapped = false;
	private View view = null;
	
	public View getView() { return view; }
	
	public static void setWrapped(boolean b) { wrapped = b; }
	public void setView(View val) { view = val; }
