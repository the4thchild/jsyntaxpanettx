...
// ADDED: copied from SyntaxView with changes to extend WrappedPlainView
// TODO: consider sharing code between the two classes to avoid duplication

public class SyntaxViewWrapped extends WrappedPlainView {
    ...
    private static final Logger log = Logger.getLogger(SyntaxViewWrapped.class.getName());
     ...
     * @param config
     */
    public SyntaxViewWrapped(Element element, Configuration config) {
        super(element);
...
//    protected void updateDamage(javax.swing.event.DocumentEvent changes,
	...
	@Override
	public void setParagraphInsets(AttributeSet attr) {
